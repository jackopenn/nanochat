...
parser.add_argument("--head-muon", action="store_true", help="enable per-head Muon orthogonalization for attention weights")
...
while True:
    ...
    for group in optimizer.param_groups:
        ...
        if group['kind'] in ('muon', 'head_muon'):
